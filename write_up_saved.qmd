...
In this subsection, a word-level analysis was conducted. The top 20 positive and negative words in the speeches as a whole, as well as a breakdown per president using the *bing* lexicon are presented below. \>\>\>\>\>\>\> Stashed changes
...
The first figure displays the average sentiment segregated by year and president. Nelson\
...
The second figure echos the analysis that is portrayed in Figure 1. A further comment can\
