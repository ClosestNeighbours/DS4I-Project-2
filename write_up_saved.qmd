...
![15 Most Spoken Words Per President Including Common Words](New%20pics/15mostcommon.png)
...
![15 Most Spoken Words Per President Not Including Common Words](New%20pics/15mostcommon_withoutcommon.png)
...
```{r Top 20 Positive Words, message=FALSE, echo=FALSE, fig.align='center', fig.show="hold", fig.cap="Top 20 positive words used in speeches based on the bing lexicon"}
sona_sentiment %>%
...
```{r Top 10 Positive Words by President, message=FALSE, echo=FALSE, fig.align='center', fig.show="hold", fig.cap="Top 20 positive words by president based on the bing lexicon"}
...
```{r Top 20 Negative Words, message=FALSE, echo=FALSE, fig.align='center', fig.show="hold", fig.cap="Top 20 negative words used in speeches based on the bing lexicon"}
sona_sentiment %>%
...
```{r Top 10 Negative Words by President, message=FALSE, echo=FALSE, fig.align='center', fig.show="hold", fig.cap="Top 20 negative words by president based on the bing lexicon"}
...
```{r Sentiment Prop by President, message=FALSE, echo=FALSE, fig.align='center', fig.show="hold", fig.cap="Proportion of positive to negative words by president based on the bing lexicon"}
...
```{r Sentiment Bars by President (nrc), message=FALSE, echo=FALSE, fig.align='center', fig.show="hold", fig.cap="Proportion of positive to negative words by president based on the bing lexicon"}
sona_sentiment %>%
...
```{r Trends over Time, message=FALSE, echo=FALSE, fig.align='center', fig.show="hold", fig.cap="Proportion of positive to negative words by president based on the bing lexicon"}
...
![The 20 Most Used Terms per Topic](New%20pics/20mostused.png)
...
![Topic Modelling for de Klerk](New%20pics/dklerk.png)
...
![Topic Modelling for Mandela](New%20pics/mandela.png)
...
![Topic Modelling for Mbeki](New%20pics/mbeki.png)
...
![Topic Modelling for Motlanthe](New%20pics/motlanthe.png)
...
![Topic Modelling for Zuma](New%20pics/zuma.png)
...
![Topic Modelling for Ramaphosa](New%20pics/ramaphosa.png)
...
![Yearly Sentiment Trends segregated by presidents.](docs/Sentiment_Trend_over_the_years.png)
...
![Figure Demonstrating Two Topics Against Beta from 1994-1999](docs/lda_1990.png)
...
![Figure Demonstrating Two Topics Against Beta from 2000-2010](docs/lda_2000.png)
...
![Figure Demonstrating Two Topics Against Beta from 2010-2020](docs/lda_2010.png)
...
![Figure Demonstrating Two Topics Against Beta from 2020-2023](docs/lda_2020.png)
